...
GUIMainMenu::GUIMainMenu(SunGUIWindow &window) :
        ...
        v(glm::ivec2(50, 50), glm::ivec2(400, 400), glm::vec4(1.0f)),
    ...
    // Constraints
    /*view.addConstraint(
        v[SunGUIView::ConstraintValue::Left] == view[SunGUIView::ConstraintValue::Left] + 10
    );*/
    /*view.addConstraint(
        v[SunGUIView::ConstraintValue::Width] == view[SunGUIView::ConstraintValue::Width] - 20
    );*/
}
