...
class Control {
public:
    /// Constructs the control with a position and a size
    Control(glm::ivec2 _position, glm::ivec2 _size);

    /// Constructs the control with a position, size, and initializer list of children
    Control(glm::ivec2 _position, glm::ivec2 _size, std::initializer_list<Control *> _children);
