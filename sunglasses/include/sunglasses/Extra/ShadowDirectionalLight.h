...
#ifndef SHADOWDIRECTIONALLIGHT_H
#define SHADOWDIRECTIONALLIGHT_H
...
class ShadowDirectionalLight : public DirectionalLight {
public:
    /// A constructor
     ...
     */
    ShadowDirectionalLight(glm::vec3 _color, glm::vec3 _direction);
