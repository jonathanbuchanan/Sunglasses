...
${OBJECTDIR}/Graphics/SunCamera.o: Graphics/SunCamera.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Graphics/SunCamera.o Graphics/SunCamera.cpp

${OBJECTDIR}/Graphics/SunMesh.o: Graphics/SunMesh.cpp 
	${MKDIR} -p ${OBJECTDIR}/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Graphics/SunMesh.o Graphics/SunMesh.cpp

${OBJECTDIR}/Graphics/SunModel.o: Graphics/SunModel.cpp 
	${MKDIR} -p ${OBJECTDIR}/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Graphics/SunModel.o Graphics/SunModel.cpp
...
${OBJECTDIR}/Physics/SunPhysicsColliderPlane.o: Physics/SunPhysicsColliderPlane.cpp 
	${MKDIR} -p ${OBJECTDIR}/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Physics/SunPhysicsColliderPlane.o Physics/SunPhysicsColliderPlane.cpp
...
${OBJECTDIR}/Physics/SunPhysicsForce.o: Physics/SunPhysicsForce.cpp 
	${MKDIR} -p ${OBJECTDIR}/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Physics/SunPhysicsForce.o Physics/SunPhysicsForce.cpp

${OBJECTDIR}/Physics/SunPhysicsObject.o: Physics/SunPhysicsObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Physics/SunPhysicsObject.o Physics/SunPhysicsObject.cpp

${OBJECTDIR}/Physics/SunPhysicsSimulator.o: Physics/SunPhysicsSimulator.cpp 
	${MKDIR} -p ${OBJECTDIR}/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Physics/SunPhysicsSimulator.o Physics/SunPhysicsSimulator.cpp

${OBJECTDIR}/Physics/SunPhysicsWorld.o: Physics/SunPhysicsWorld.cpp 
	${MKDIR} -p ${OBJECTDIR}/Physics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Physics/SunPhysicsWorld.o Physics/SunPhysicsWorld.cpp
...
${OBJECTDIR}/SunDirectionalLightObject.o: SunDirectionalLightObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SunDirectionalLightObject.o SunDirectionalLightObject.cpp
...
${OBJECTDIR}/SunObject.o: SunObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SunObject.o SunObject.cpp

${OBJECTDIR}/SunPointLightObject.o: SunPointLightObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SunPointLightObject.o SunPointLightObject.cpp

${OBJECTDIR}/SunScene.o: SunScene.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SunScene.o SunScene.cpp
